...
<p style=text-indent:25px;> Позвольте представиться: меня зовут <B> <I> Шиповалова Дарья </I>
<p style=text-indent:25px;> Я люблю <B> Фантастику, компьютеры и музыку в стиле Black Metal. </B>
<p style=text-indent:25px;> Терпеть не могу <B> РЭП и хомячков. </B>
